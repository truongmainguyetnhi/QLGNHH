                            ...
                            <div class="body_update">
                                <div class="giao">
                                    <section class="them_body">
                                        <form name="updatepacket_dc" id="update_packet_dc" class="test" onsubmit="alert('Thành công')" method="post" enctype="multipart/form-data" action="./elements/mpacket/packetAct.php?reqact=updatepacket_diachi">
                                            <?php
                                            foreach ($list_packet as $n) {
                                            ?>
                                                ...
                                                <div class="fields">
                                                    ...
                                                    <div class="input_group type-md">
                                                        <select name="ttdh">
                                                            <option value="Đã tạo đơn" <?php echo ($n->TRANGTHAI_DH == 'Đã tạo đơn') ? 'selected' : ''; ?>>Đã tạo đơn
                                                            </option>
                                                            <option value="Đang vận chuyển" <?php echo ($n->TRANGTHAI_DH == 'Đang vận chuyển') ? 'selected' : ''; ?>>
                                                                Đang vận chuyển</option>
                                                            <option value="Giao thành công" <?php echo ($n->TRANGTHAI_DH == 'Giao thành công') ? 'selected' : ''; ?>>
                                                                Giao thành công</option>
                                                            <option value="Đã hủy" <?php echo ($n->TRANGTHAI_DH == 'Đã hủy') ? 'selected' : ''; ?>>Đã hủy
                                                            </option>
                                                            <option value="Hoàn trả" <?php echo ($n->TRANGTHAI_DH == 'Hoàn trả') ? 'selected' : ''; ?>>Hoàn trả
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="input_group type-md">
                                                    ...
                                                    <div class="input_group type-md">
                                                        <input type="text" name="ghichu" value="<?php echo htmlspecialchars($n->GHICHU); ?>" required>
                                                    ...
                                                    ?>
                                                    <div class="input_group type-md">
                                                        <input type="datetime-local" name="ngaygiao" required placeholder="Ngày giao" value="<?php echo $currentDateTime; ?>">
                                                        <label for="ngaygiao" style="top: -0.5rem;">Ngày giao</label>
                                                        <span class="border"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="fields">
                                                    ...
                                                    <div class="input_group type-md read">
                                                        <input type="text" name="tongtien" value="<?php echo $n->TONGTIENHANG; ?>" required readonly>
